...
class Timeouts(float, Enum):
    ...
    PAYMENT_SERVICE_SELECTION_REQ = 10
    CERTIFICATE_INSTALLATION_REQ = 10
    CERTIFICATE_UPDATE_REQ = 10
    PAYMENT_DETAILS_REQ = 10
    AUTHORIZATION_REQ = 10
    CHARGE_PARAMETER_DISCOVERY_REQ = 10
    CHARGING_STATUS_REQ = 10
    METERING_RECEIPT_REQ = 10
    POWER_DELIVERY_REQ = 10
    CABLE_CHECK_REQ = 10
    PRE_CHARGE_REQ = 10
    CURRENT_DEMAND_REQ = 2
    WELDING_DETECTION_REQ = 10
    SESSION_STOP_REQ = 10
